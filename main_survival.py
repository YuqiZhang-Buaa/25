...
parser.add_argument('--model_type', type=str, choices=['mean_mil', 'max_mil', 'att_mil','trans_mil', 's4model','mamba_mil', 'spe_mil_re_4', 'spe_mil_re_2_57', 'rrt', 'NA_with_alibi','clam_sb', 'spe_mil_re_3'], default='mamba_mil', 
                    help='type of model')
